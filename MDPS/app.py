...
#diabetes model
diabetes_model, scaler1 = pickle.load(open('D:\MDPS\project_model\diabetes_model.pkl','rb'))
#heart disease model
heart_disease_model, scaler2 = pickle.load(open('D:\MDPS\project_model\heart_disease_model.pkl','rb'))
#parkinson model
parkinson_model, scaler3 = pickle.load(open('D:\MDPS\project_model\parkinson_model.pkl','rb'))
